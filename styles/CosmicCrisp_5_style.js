...
var style_CosmicCrisp_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var repeat = 0;
    var placement = 'point';
    if (exp_label_CosmicCrisp_5_eval_expression(context) !== null && resolution > 0 && resolution < 7) {
        labelText = String(exp_label_CosmicCrisp_5_eval_expression(context));
    }
