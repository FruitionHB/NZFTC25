...
map.getView().fit([19678946.136147, -4815248.505662, 19701165.091628, -4801210.900643], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">NZ Fruit Tree Co 2026</h2>';
        return titleElement;
    })(),
